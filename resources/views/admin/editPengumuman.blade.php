                                ...
                                <div class="card-header py-3">
                                    <div class="row px-2">
                                        ...
                                        <input type="text" name="judul" id="contact-company"
                                            class="form-control mb-2" value="{{ $pengumuman->judul }}">

                                        <label for="isi">Isi Pengumuman</label>
                                        <textarea name="isi" rows="3" class="form-control mb-2" id="contact-message" name="isi"
                                            placeholder="Tuliskan Isi Pengumuman..." style="resize: none; height: 100px;">{{ $pengumuman->isi }}</textarea>

                                        <button type="submit" class="form-control btn btn-warning">Edit
                                            Pengumuman</button>
                                    </div>
